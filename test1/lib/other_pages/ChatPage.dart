    ...
    return Scaffold(
      appBar: AppBar(
          title: (isConnecting
              ...
              : isConnected
                  ? Text('Controlling wheelchair from ' + serverName)
                  : Text('Control log of ' + serverName))),
      body: SafeArea(
        child: Column(
          children: <Widget>[
            Flexible(
            ...
            ControlButton(
              ...
              externalDiameter: 350,
              internalDiameter: 150,
              dividerColor: Color.fromARGB(255, 0, 0, 0),
              elevation: 2,
              externalColor: Color.fromARGB(255, 18, 217, 101),
              internalColor: Color.fromARGB(255, 86, 83, 73),
              mainAction: () {
                message("5");
              },
              sections: [
            ...
            Row(
              children: <Widget>[
                ...
                //         onPressed:
                //             isConnected ? () => const speechTotext() : null)),
              ],
            )
          ],
        ),
